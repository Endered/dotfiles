...
/**
 * [bindgen] header: /nix/store/gdq1i8iwvxjznbfnmg83lg5sgy35qp8i-glib-2.82.5-dev/include/glib-2.0/gio/gmenumodel.h
*/
opaque type GMenuModel = CStruct2[GObject, Ptr[GMenuModelPrivate]]

object GMenuModel:
  given _tag: Tag[GMenuModel] = Tag.materializeCStruct2Tag[GObject, Ptr[GMenuModelPrivate]]
  ...
  // Allocates GMenuModel on the heap – fields are not initalised or zeroed out
